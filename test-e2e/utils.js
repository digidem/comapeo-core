 ...
 */
export async function createOldManagerOnVersion2_0_1(t, seed, overrides = {}) {
  return createOldManager(t, '2.0.1', seed, overrides)
}
 ...
 * @returns {Promise<any>}
 */
export async function createOldManager(t, version, seed, overrides = {}) {
