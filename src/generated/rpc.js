...
export var Invite = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.encryptionKeys = EncryptionKeys.decode(
            reader,
            reader.uint32()
          )
          continue
        case 3:
          ...
          message.projectInfo = Invite_ProjectInfo.decode(
            reader,
            reader.uint32()
          )
          continue
  ...
  fromPartial: function (object) {
    ...
    message.encryptionKeys =
      object.encryptionKeys !== undefined && object.encryptionKeys !== null
        ? EncryptionKeys.fromPartial(object.encryptionKeys)
        : undefined
    message.projectInfo =
      object.projectInfo !== undefined && object.projectInfo !== null
...
export var Invite_ProjectInfo = {
  ...
  create: function (base) {
    return Invite_ProjectInfo.fromPartial(
...
export var InviteResponse = {
  ...
  create: function (base) {
    return InviteResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    )
  },
  fromPartial: function (object) {
    ...
    message.projectKey =
      (_a = object.projectKey) !== null && _a !== void 0 ? _a : Buffer.alloc(0)
    message.decision =
      (_b = object.decision) !== null && _b !== void 0
        ? _b
