...
export const knownStatesTable = sqliteTable('knownStates', {
  deviceId: blob('deviceId', { mode: 'buffer' }).notNull(),
  writerDeviceId: blob('deviceId', { mode: 'buffer' }).notNull(),
  dataType: text('dataType', { enum: ['auth', 'config', 'data'] }).notNull(),
