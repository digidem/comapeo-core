...
export class Discovery extends TypedEmitter {
   ...
   *
   * // Create topic name (as a buffer) to be joined (see footnote 1)
   * const topic = Buffer.from('topics-example')
   *
   * discover.join(topic)
   *
   * console.log(discover.topics) // prints out `['746f706963732d6578616d706c65']`
   * ```
   *
   * Footnotes:
   *
   ...
   *
   * ```js
   * const topic = Buffer.from('join-example')
