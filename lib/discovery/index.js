 ...
 * @property {(connection: SecretStream<RawConnectionStream>, info: PeerInfo) => void} connection
...
export class Discovery extends TypedEmitter {
   ...
   *
   * @private
   * @param {SecretStream<RawDHTConnectionStream>} connection
   ...
   * @returns {SecretStream<net.Socket>}
   */
  _connect(options) {
