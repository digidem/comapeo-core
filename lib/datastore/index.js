...
export class DataStore {
   ...
   */
  constructor({ dataType, corestore, indexer, keyPair, identityPublicKey, name }) {
    this.name = name
    this.#dataType = dataType
    this.#corestore = corestore
    this.#indexer = indexer
    this.#keyPair = keyPair
    this.identityPublicKeyString = (identityPublicKey || keyPair?.publicKey)?.toString('hex')
  }
  ...
  async create(data) {
    ...
    const doc = Object.assign(data, {
      ...
      creatorId: this.identityPublicKeyString,
