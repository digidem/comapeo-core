...
- [CorestoreStorage](classes/CorestoreStorage.md)
...
- [CorePointer](interfaces/CorePointer.md)
- [CorestoreEvents](interfaces/CorestoreEvents.md)
- [CorestoreStorageOptions](interfaces/CorestoreStorageOptions.md)
- [CoreStreamEntry](interfaces/CoreStreamEntry.md)
